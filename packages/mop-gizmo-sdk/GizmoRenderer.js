...
export class GizmoRenderer {
    ...
    updateGizmoBox(nodeId) {
        ...
        // Assumption: Editor needs container or a method to get node element
        ...
        if (!gizmoEl) {
            ...
            deleteBtn.onclick = (e) => {
                ...
                if (confirm('Delete this node?')) {
                    ...
                    } else if (this.editor.deleteNode) {
                        // Fallback Pattern
